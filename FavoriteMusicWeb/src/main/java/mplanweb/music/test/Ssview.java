...
public class Ssview implements Serializable {
	...
	private int mp_mpnum; // : 아티스트
	private int mp_num; // : 아티스트
	private String mp_artist; // : 아티스트
	private String mp_title; // : 아티스트
	private String mp_album; // : 아티스트
	private String mp_lyric; // : 아티스트
	private String mp_year; // : 아티스트
	private String mp_corp; // : 아티스트
	private String mp_label; // : 아티스트
	private String mp_genre1; // : 아티스트
	private String mp_genre2; // : 아티스트
	private String mp_etc; // : 아티스트
	private String mp_img; // : 아티스트
	private String mp_320k; // : 아티스트
	private String mp_192k; // : 아티스트
	private long mp_imgsize; // : 아티스트
	private long mp_320size; // : 아티스트
	private long mp_192size; // : 아티스트
	private String mp_imgo; // : 아티스트
	private String mp_320ko; // : 아티스트
	private String mp_192ko; // : 아티스트
	private String mp_age; // : 아티스트
	private String mp_useyn; // : 아티스트
	private String mp_open_date; // : 아티스트
