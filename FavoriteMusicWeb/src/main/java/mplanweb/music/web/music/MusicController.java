...
public class MusicController {
	...
	public String MusicLable(Locale locale, Model model) {
	...
	@ResponseBody
	public HashMap<String, Object> ArtistUpload(
		...
		if (mimg != null) {
			...
			result.put("RadioGroup1", RadioGroup1);
	...
	// 앨범 저장
	@RequestMapping(value = "/albuminsert", produces = "application/json")
	@ResponseBody
	public HashMap<String, Object> AlbumUpload(
			MultipartHttpServletRequest request) throws Exception {
		// ///////////////////////////////////////////////////////////////////////
		// Hashmap 생성
		// ///////////////////////////////////////////////////////////////////////
		...
		// ///////////////////////////////////////////////////////////////////////
		String artist = request.getParameter("artist"); // 아티스트 이름 Request
		String album = request.getParameter("album"); // 음원제목 Request
		String year = request.getParameter("year"); // 앨범명 Request
		String content = request.getParameter("content"); // 가사 Request
		String corp = request.getParameter("corp"); // 가사 Request
		String RadioGroup1 = request.getParameter("RadioGroup1"); // 음원제목
		// Request
		// ///////////////////////////////////////////////////////////////////////
		// 업로드 파일 Request Html File name=[getFile] ==> MultipartFile = [getFile]
		...
		if (mimg != null) {
			...
			Album albumarr = new Album();
			albumarr.setArtist(artist);
			albumarr.setAlbum(album);
			albumarr.setYear(year);
			albumarr.setContent(content);
			albumarr.setCorp(corp);
			albumarr.setFimgName(fimgName);
			albumarr.setImgsize(imgsize);
			albumarr.setUploadFimgName(uploadFimgName);
			albumarr.setRadioGroup1(RadioGroup1);
			logger.info("albumarr" + albumarr);
			musicserviceimpl.albuminsert(albumarr);
			result.put("artist", artist);
	...
	// 싱글
	@RequestMapping(value = "/ssinsert", produces = "application/json")
	@ResponseBody
	public HashMap<String, Object> fileUploads(
		...
		if (mimg != null && m192k != null && m320k != null) {
			...
			soundsource.setArtist(artist);
			soundsource.setTitle(title);
			soundsource.setAlbum(album);
			soundsource.setLyric(lyric);
			soundsource.setYear(year);
			soundsource.setCorp(corp);
			soundsource.setFimgName(fimgName);
			soundsource.setImgsize(imgsize);
			soundsource.setUploadFimgName(uploadFimgName);
			soundsource.setF192Name(f192Name);
			soundsource.setM192size(m192size);
			soundsource.setUploadF192Name(uploadF192Name);
			soundsource.setF320Name(f320Name);
			soundsource.setM320size(m320size);
			soundsource.setUploadF320Name(uploadF320Name);
			soundsource.setNum(num);
			soundsource.setLabel(label);
			soundsource.setGenre1(genre1);
			soundsource.setGenre2(genre2);
			soundsource.setEtc(etc);
			soundsource.setCopy(copy);
			soundsource.setAge(age);
			soundsource.setRadioGroup1(RadioGroup1);

			musicserviceimpl.Soundsourceinsert(soundsource);
