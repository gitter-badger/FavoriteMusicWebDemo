...
public class Sscorp implements Serializable {
	private int mp_corpnum; // : 음원넘버
	private String mp_corpname; // : 아티스트
	private String mp_number; // : 아티스트
	private String mp_address; // : 아티스트
	private String mp_contents; // : 아티스트
	private String mp_person; // : 아티스트
	private String mp_phone; // : 아티스트
