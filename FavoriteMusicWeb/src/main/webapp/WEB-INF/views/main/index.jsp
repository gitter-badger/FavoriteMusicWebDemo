...
<html>
    ...
    <link href="resources/main/bootstrap/css/bootstrap.min.css" rel="stylesheet" type="text/css">
    <link href="resources/main/iCheck/square/blue.css" rel="stylesheet" type="text/css" />
    <link href="https://maxcdn.bootstrapcdn.com/font-awesome/4.3.0/css/font-awesome.min.css" rel="stylesheet" type="text/css" />
    <link href="resources/main/css/_all-skins.min.css" rel="stylesheet" type="text/css">
    ...
    <script src="resources/main/jQuery/jQuery-2.1.3.min.js" type="text/javascript"> </script>
    <script src="resources/main/modalLayer.js" type="text/javascript"> </script>
    <script type="text/javascript">
$(function(){
    $("#openmodal").click(function(){
        $.blockUI({message : $('#modallogin')})
    })
})
function removeModal(){
    ...
    <script src="resources/main/bootstrap/js/bootstrap.min.js" type="text/javascript"> </script>
...
<div class="modal" id="modallogin">
    ...
    <div class="login-box-body">
        ...
        <div class="row">
          ...
          <button type="button" class="closeModalLayer" onClick="removeModal()">닫기</button>
        </div>
  </div>
    </div>
...
<div id="center"> 
    ...
    <div class="box-body">
        ...
        <div class="info-box-content"> <span class="info-box-text">음원보유수</span> <span class="info-box-number">10,000,000곡</span> </div>
        <!-- /.info-box-content --> 
      </div>
          <!-- /.info-box -->
          
          <div class="info-box"> <span class="info-box-icon bg-aqua"><i class="fa fa-envelope-o"></i></span>
        <div class="info-box-content"> <span class="info-box-text">라디오 채널수</span> <span class="info-box-number">20개</span> </div>
        <!-- /.info-box-content --> 
      </div>
          <!-- /.info-box -->
          
          <div class="info-box"> <span class="info-box-icon bg-aqua"><i class="fa fa-envelope-o"></i></span>
        <div class="info-box-content"> <span class="info-box-text">오늘 등록된 음원수</span> <span class="info-box-number">1,240곡</span> </div>
        <!-- /.info-box-content --> 
      </div>
          <!-- /.info-box -->
          
          <div class="info-box"> <span class="info-box-icon bg-aqua"><i class="fa fa-envelope-o"></i></span>
        <div class="info-box-content"> <span class="info-box-text">총 유저수</span> <span class="info-box-number">120,020명</span> </div>
        <!-- /.info-box-content --> 
      </div>
          <!-- /.info-box --> 
        </div>
...
<!-- Start Footer -->
<div id="footer">
      <div class="footerwarp" id="footerwarp"> <a href="#" class="footersize">Favorite Music</a>
