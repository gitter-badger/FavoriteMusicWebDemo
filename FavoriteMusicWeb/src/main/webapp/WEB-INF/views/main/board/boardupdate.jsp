...
<body>
	...
	-->
		<form name="tx_editor_form" id="tx_editor_form" action="../board/boardwrite" method="post"
			accept-charset="utf-8" enctype="multipart/form-data">
			<input type="hidden" id="num" name="num">
			<div class="form-group">
				<label for="titlename" class="col-sm-1 control-label">제목 </label>
				<div class="col-sm-5">
			...
			-->
				...
				<div id="tx_canvas" class="tx-canvas">
					<div id="tx_loading" class="tx-loading">
						<div>
							<img src="../resources/editor/images/icon/editor/loading2.png" width="113"
				...
				<div id="tx_resizer" class="tx-resize-bar">
					...
					<img id="tx_resize_holder"
						src="../resources/editor/images/icon/editor/skin/01/btn_drag01.gif" width="58"
					...
					<div id="tx_attach_box" class="tx-attach-box">
						<div class="tx-attach-box-inner">
							<div id="tx_attach_preview" class="tx-attach-preview">
								<p></p>
								<img src="../resources/editor/images/icon/editor/pn_preview.gif" width="147"
...
<script type="text/javascript">
	...
	function setForm(editor) {
       ...
       // form.createField(textarea);
        form.createField(tx.textarea({'name' : "content", 'style' : { 'display' : "none"}}, content));
