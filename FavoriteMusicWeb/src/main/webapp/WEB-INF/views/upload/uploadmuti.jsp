...
<script>
	$(document).ready(function() {
		...
		$('#multiform input[name=file]').MultiFile({
			...
			maxfile : 16384, //각 파일 최대 업로드 크기
			maxsize : 49152, //전체 파일 최대 업로드 크기
...
<body>
	...
	<form name="multiform" id="multiform"
		...
		<input type="file" name="uploadFile"><br /> 음질320k <input
			type="file" name="uploadFile"><br /> 음질192k <input
