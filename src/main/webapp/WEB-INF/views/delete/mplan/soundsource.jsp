...
<body>
	...
	<form name="multiform" id="multiform"
		action="<%=request.getContextPath()%>/ssinsert" method="POST"
		...
		</select><br /> 아티스트 : <input type="text" size="20px" name="artist" /> <br />
		타이틀 : <input type="text" size="20px" name="title" /> <br /> 앨범명 : <input
			type="text" size="20px" name="album" /> <br /> 가사입력 :
		<textarea rows="10" cols="20" size="20px" name="lyric"></textarea>
		<br /> 년도 : <input type="date" size="20px" name="year"><br />
		레이블 : <input type="text" size="20px" name="label" /> <br /> 유통사 : <input
			type="text" size="20px" name="corp" /> <br /> 1차 분류(가요/팝) : <select
			name="genre1">
		...
		</select> <br /> 2차 분류(장르) : <select name="genre2">
		...
		</select> <br /> 기타 : <input type="text" size="20px" name="etc" /> <br />
		오픈일 : <input type="datetime-local" name="copy"><br /> 연령제한 :
		<select name="age">
