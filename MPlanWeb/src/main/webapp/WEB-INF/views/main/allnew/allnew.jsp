...
<script src="../resources/test/bootstrap/js/bootstrap.min.js"
	type="text/javascript"></script>
	<script
	src="../resources/bower_components/bootstrap-paginator/build/bootstrap-paginator.min.js"></script>
</head>
<body>
	...
	<div id="center">
		<div class="centerwrap">
			...
			<div class="tabmusic">
				<h3>최신음악</h3>
				<ul class="newMusic">
					<li class="all"><a href="/web/allnew/list" class="on">종합</a></li>
					<li class="kpop"><a href="/web/allnew/kpoplist" class="">가요</a></li>
